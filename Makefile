...
ARCH            ?= arm64
CROSS_COMPILE   ?= $(srctree)/toolchains/aarch64-android-4.9-llvm/bin/aarch64-linux-android-
...
# CC		= $(srctree)/toolchains/clang-r383902/bin/clang
CC		= $(srctree)/toolchains/clang-r416183b/bin/clang
